...
typedef struct client_s {
	...
	// gaoesa, gamestate flooding
	int prevGamestateSent;
} client_t;
...
// OOB flooding
extern cvar_t *sv_AF_OOBSeconds;
extern cvar_t *sv_AF_OOBPackets;
extern cvar_t *sv_AF_OOBRestTime;
...
typedef struct ipTries_s{
	netadr_t		ip;
	short			tries;		// The number of tries between the times
	int				firstReq;	// The oldest known request
	int				lastReq;	// The latest request
	short			someStatus;
} ipTries_t;
