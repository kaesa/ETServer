...
//	sv_gameskill = Cvar_Get ("g_gameskill", "3", CVAR_SERVERINFO | CVAR_LATCH );
	...
	// anti HTTP flood sv_AF_OOBPackets
	sv_AF_OOBPackets = Cvar_Get("sv_AF_OOBPackets", "5", CVAR_ARCHIVE);
	sv_AF_OOBSeconds = Cvar_Get("sv_AF_OOBSeconds", "3", CVAR_ARCHIVE);
	sv_AF_OOBRestTime = Cvar_Get("sv_AF_OOBRestTime", "4", CVAR_ARCHIVE);
