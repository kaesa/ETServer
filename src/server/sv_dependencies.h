...
Module added for the server project. This module contains all game logic dependencies. Which neither mod or the server can not break.

*/

#ifndef __SV_DEPENDENCIES_H__
#define __SV_DEPENDENCIES_H__
...
typedef enum {
	...
	G_ARGV,         // ( int n, char *buffer, int bufferLength );		// 10

	G_FS_FOPEN_FILE,    // ( const char *qpath, fileHandle_t *file, fsMode_t mode );
	G_FS_READ,      // ( void *buffer, int len, fileHandle_t f );
	G_FS_WRITE,     // ( const void *buffer, int len, fileHandle_t f );
	G_FS_RENAME,
	G_FS_FCLOSE_FILE,       // ( fileHandle_t f );						// 15
	...
	G_SET_CONFIGSTRING, // ( int num, const char *string );					// 20
	...
	G_SET_BRUSH_MODEL,  // ( gentity_t *ent, const char *name );				// 25
	...
	G_ADJUST_AREA_PORTAL_STATE, // ( gentity_t *ent, qboolean open );			// 30
	...
	G_ENTITY_CONTACT,   // ( const vec3_t mins, const vec3_t maxs, const gentity_t *ent );		// 35
...
// done.
	...
	BOTLIB_AI_CHARACTERISTIC_BINTEGER,	// 505
	BOTLIB_AI_CHARACTERISTIC_STRING,

	BOTLIB_AI_ALLOC_CHAT_STATE,
	BOTLIB_AI_FREE_CHAT_STATE,
	BOTLIB_AI_QUEUE_CONSOLE_MESSAGE,
	BOTLIB_AI_REMOVE_CONSOLE_MESSAGE,	// 510
	...
	BOTLIB_AI_UNIFY_WHITE_SPACES,		// 520
	...
	BOTLIB_AI_DUMP_AVOID_GOALS,			// 530
	...
	BOTLIB_AI_MOVE_IN_DIRECTION,		// 550
	...
	BOTLIB_AI_NUM_INITIAL_CHATS,		// 570
